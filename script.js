...
const hex1 = KUTE.fromTo(
    ...
    {path: '#l1a'},
    {path: '#l1b'},
    {repeat: 999, duration: 9800, yoyo: true}
)
...
const hex2 = KUTE.fromTo(
    ...
    {path: '#l2a'},
    {path: '#l2b'},
    {repeat: 999, duration: 9600, yoyo: true}
)
...
const hex3 = KUTE.fromTo(
    ...
    {path: '#l3a'},
    {path: '#l3b'},
    {repeat: 999, duration: 9400, yoyo: true}
)
...
const hex4 = KUTE.fromTo(
    ...
    {path: '#l4a'},
    {path: '#l4b'},
    {repeat: 999, duration: 9200, yoyo: true}
)
...
const hex6 = KUTE.fromTo(
    ...
    {path: '#l6a'},
    {path: '#l6b'},
    {repeat: 999, duration: 8800, yoyo: true}
)
...
const hex7 = KUTE.fromTo(
    ...
    {path: '#l7a'},
    {path: '#l7b'},
    {repeat: 999, duration: 8600, yoyo: true}
)
...
const hex8 = KUTE.fromTo(
    ...
    {path: '#l8a'},
    {path: '#l8b'},
    {repeat: 999, duration: 8400, yoyo: true}
)
...
const hex9 = KUTE.fromTo(
    ...
    {path: '#l9a'},
    {path: '#l9b'},
    {repeat: 999, duration: 8200, yoyo: true}
)
...
const hex12 = KUTE.fromTo(
    ...
    {path: '#l12a'},
    {path: '#l12b'},
    {repeat: 999, duration: 7600, yoyo: true}
)
...
const hex13 = KUTE.fromTo(
    ...
    {path: '#l13a'},
    {path: '#l13b'},
    {repeat: 999, duration: 7400, yoyo: true}
)
...
const hex14 = KUTE.fromTo(
    ...
    {path: '#l14a'},
    {path: '#l14b'},
    {repeat: 999, duration: 7200, yoyo: true}
)
...
const hex16 = KUTE.fromTo(
    ...
    {path: '#l16a'},
    {path: '#l16b'},
    {repeat: 999, duration: 6800, yoyo: true}
)
...
const hex17 = KUTE.fromTo(
    ...
    {path: '#l17a'},
    {path: '#l17b'},
    {repeat: 999, duration: 6600, yoyo: true}
)
...
const hex18 = KUTE.fromTo(
    ...
    {path: '#l18a'},
    {path: '#l18b'},
    {repeat: 999, duration: 6400, yoyo: true}
)
...
const hex19 = KUTE.fromTo(
    ...
    {path: '#l19a'},
    {path: '#l19b'},
    {repeat: 999, duration: 6200, yoyo: true}
)
...
const hex21 = KUTE.fromTo(
    ...
    {path: '#l21a'},
    {path: '#l21b'},
    {repeat: 999, duration: 5800, yoyo: true}
)
...
const hex22 = KUTE.fromTo(
    ...
    {path: '#l22a'},
    {path: '#l22b'},
    {repeat: 999, duration: 5600, yoyo: true}
)
...
const hex23 = KUTE.fromTo(
    ...
    {path: '#l23a'},
    {path: '#l23b'},
    {repeat: 999, duration: 5400, yoyo: true}
)
...
const hex24 = KUTE.fromTo(
    ...
    {path: '#l24a'},
    {path: '#l24b'},
    {repeat: 999, duration: 5200, yoyo: true}
)
